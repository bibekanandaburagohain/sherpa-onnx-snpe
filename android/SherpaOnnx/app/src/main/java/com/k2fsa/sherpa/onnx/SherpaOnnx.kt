...
class SherpaOnnx(
    ...
    fun getNativeParentDir(): String = getNativeParentDirectory()
    ...
    private external fun getNativeParentDirectory(): String
...
data class OnlineModelConfig(
    ...
    var qnn_lib_path: String = "libQnnHtp.so"
)
