...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qnn_lib_path = applicationInfo.nativeLibraryDir + "/" +qnn_lib_path
        Log.i(TAG, "QNN PATH:${qnn_lib_path}")
    ...
    private fun initModel() {
        ...
        config.modelConfig.qnn_lib_path = qnn_lib_path
